...
.listener_ready:
            ...
            ; Wait for the listener's EOI acknowledgment: DATA LOW, then
            ; released again. v27: both of these used to fall through to
            ; the success label when they expired, so a listener that never
            ; answered an EOI was indistinguishable from one that did, and
            ; the last byte of every file was sent into the dark.
            JSR IEC_WAIT_ACK
