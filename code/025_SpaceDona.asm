...
alienFire:
;choose alien
;record fire position
;draw fire
;advance fire
;check collision with ship
;       destroy ship if collision
;if end screen destroy fire
  lda fireInPlayAlien
  bne alienFireContinue
  ;start alien fire
  lda #$86 ;arbitrary position to test
  sta firePositionAlien
  lda #$3
  sta fireInPlayAlien  
  jsr writeFireAlien
  rts
