;Plan to create load ASCII from DISK FILE

;load ASCII from DISK file using file name to an specific RAM address

;draw ASCII from RAM memory using ACIA printAsciiDrawing

;save ASCII to DISK from specific RAM address using file name

;debug test function to load and ASCII from ROM and show it using ACIA printAsciiDrawing
;in debug file

;debug test function to load and ASCII from ROM, copying it to RAM
;and show it using ACIA printAsciiDrawing
;in debug file
