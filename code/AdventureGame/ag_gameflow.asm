...
actions_index:
  ...
  .word action_pointer_254  ; COMENZAR EL JUEGO
...
action_pointer_254:
  .word action_254_id            ; COMENZAR EL JUEGO id            [112,113]
  .word action_254_name          ; COMENZAR EL JUEGO name          [114,115]
  .word action_254_sensor_id     ; COMENZAR EL JUEGO sensor_id     [116,117]
  .word action_254_sensor_active ; COMENZAR EL JUEGO sensor_active [118,119]
  .word action_254_screen        ; COMENZAR EL JUEGO screen        [120,121]
  .word action_254_cost          ; COMENZAR EL JUEGO cost          [122,123]
  .word action_254_description   ; COMENZAR EL JUEGO description   [124,125]
action_name_offset:
...
action_254_sensor_id:
  .byte 3  ; none

action_254_sensor_active:
  .byte 1  ; on
