...
ASM_BANK1    = "acs_screens_bank1.asm"
ASM_BANK0    = "acs_screens_headers_bank0.asm"
...
def to_asm(screens, action_ids):
    ...
    Returns a tuple (bank0_asm, bank1_asm).
      bank0 = header offsets, record lengths, counts  (acs_screens_headers_bank0.asm)
      bank1 = full original output                    (acs_screens_bank1.asm)
    """
    ...
    # ==================================================================
    #  Bank 0 — headers only (offsets, record lengths, counts)
    # ==================================================================
    hdr = []
    hdr.append("; ============================================================")
    hdr.append(";  ACS Screens — auto-generated by acs_screens_to_asm.py")
    hdr.append("; ============================================================")
    hdr.append("")
    hdr.append(f"screens_index_record_length:")
    hdr.append(f"  .byte 2  ; each screens_index entry is 1 .word (2 bytes)")
    hdr.append(f"screen_action_offset:")
    hdr.append(f"  .byte {screen_0_action1_byte}  ; (byte of screen_0_action1 in screens_pointers)")
    hdr.append(f"screen_description_offset:")
    hdr.append(f"  .byte {screen_0_description_byte}  ; (byte of screen_0_description in screens_pointers)")
    hdr.append(f"screen_ascii_offset:")
    hdr.append(f"  .byte {screen_0_ascii_byte}  ; (byte of screen_0_ascii in screens_pointers)")
    hdr.append(f"screen_flashlight_on_offset:")
    hdr.append(f"  .byte {screen_0_flashlight_on_byte}  ; (byte of screen_0_flashlight_on in screens_pointers)")
    hdr.append(f"screen_flashlight_off_offset:")
    hdr.append(f"  .byte {screen_0_flashlight_off_byte}  ; (byte of screen_0_flashlight_off in screens_pointers)")
    hdr.append(f"screen_enemy_probability_offset:")
    hdr.append(f"  .byte {screen_0_enemy_prob_byte}  ; (byte of screen_0_enemy_probability in screens_pointers)")
    hdr.append(f"screen_is_secret_screen_offset:")
    hdr.append(f"  .byte {screen_0_is_secret_byte}  ; (byte of screen_0_is_secret_screen in screens_pointers)")
    hdr.append(f"screen_is_end_screen_offset:")
    hdr.append(f"  .byte {screen_0_is_end_byte}  ; (byte of screen_0_is_end_screen in screens_pointers)")
    hdr.append(f"screen_record_length:")
    hdr.append(f"  .byte {screen_0_record_length}  ; (total .word bytes per screen record)")
    hdr.append("")
    hdr.append("; ── Total screen count ──────────────────────────────────────")
    hdr.append("screen_count:")
    hdr.append(f"  .byte {len(screens)}")
    hdr.append("")
    hdr.append("; ── Total secret screens count ──────────────────────────────")
    hdr.append("screens_with_secrets:")
    hdr.append(f"  .byte {secret_count}")
    hdr.append("")
...
def main():
    ...
    bank0_asm, bank1_asm = to_asm(screens, action_ids)
    ...
    print(f"[OK] Generated '{ASM_BANK0}' (headers) and '{ASM_BANK1}' (data) with {len(screens)} screen(s).")
