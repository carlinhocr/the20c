...
mainProgramLoop:
  ...
  jsr select_screen
  ;here I can check if it is a FINISHED GAME SCREEN
  ;I can do two things, I break the loop and go to special ending:
  ; maybe i can use action and only make a new runAction where 
  ;or i can show the screen normally, ask the user for input to go through
  ;the end sequence, but I should skip the action checks for
  ;VISIBILITY, PROBABILITY OF FAILLING, PROBABILITY OF ENEMY, FLASHLIGHT and TIMERs
  ;or the ending sequences has for the ACTIONS
  ;VISIBILITY never hide
  ;PROBABILITY OF FAILLING 0
  ;PROBABILITY OF ENEMY 0
  ;COST 0
  ;NO SENSORs or I add a sensor to print using the printer :-)
  ;and for the SCREENS
  ;PROBABILITY OF ENEMY 0
