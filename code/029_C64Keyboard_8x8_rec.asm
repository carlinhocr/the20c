...
;all that i do not have a current core are #
  ...
  .byte $33,$57,$41,$34,$49,$73,$45,$b6 ; PA1
  .byte $35,$52,$44,$36,$4a,$46,$54,$43 ; PA2
  .byte $37,$59,$47,$38,$4e,$48,$55,$56 ; PA3 
  .byte $39,$7a,$4a,$30,$4d,$42,$43,$4a ; PA4
  .byte $23,$34,$4c,$4a,$4b,$44,$41,$23 ; PA5
...
;          PB0,Pb1,PB2,PB3,PB4,PB5,PB6,Pb7
;   .ascii "#","#","#","#","#","#","#","#" PA0
;   .ascii "3","W","A","4","Z","S","E","#" PA1
;   .ascii "5","R","D","6","C","F","T","X" PA2
;   .ascii "7","Y","G","8","B","H","U","V" PA3
;   .ascii "9","I","J","0","M","K","O","N" PA4
;   .ascii "+","P","L","-",".",":","@","," PA5
;   .ascii "£","*","#","#","#","=","#","/" PA6
;   .ascii "1","#","#","2"," ","#","Q","#" PA7
