...
read_buffer_ptr_low =$60
read_buffer_ptr_high =$61
write_buffer_ptr_low=$62
write_buffer_ptr_high=$63
readBufferPtr=$64
writeBufferPtr=$65
...
;Input buffer leave all reserved up to $03FF
inputBuffer=$0300
inputBufferEnd=$03ff
...
uartSerialInit:
  ...
  lda #%00011111 ;8-N-1 = No parity, 8 bits, 1 Stop Bit, 19200 baudios
  sta ACIA_CTRL
  ...
  ;bit 1 =0 -> Receiver interrupt request enable
  ...
  lda #> inputBuffer
  sta read_buffer_ptr_high
  lda #< inputBuffer
  sta write_buffer_ptr_low
  lda #> inputBuffer
  sta write_buffer_ptr_high
  lda #$0
  sta readBufferPtr
  sta writeBufferPtr
